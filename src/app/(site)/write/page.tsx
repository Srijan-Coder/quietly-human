...
export default async function WritePage() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg text-brand-text pt-24 md:pt-32 px-6 md:px-12 w-full pb-32">
      <div className="max-w-6xl mx-auto">
        <header className="mb-12 border-b border-brand-border pb-8 text-center flex flex-col items-center">
          <span className="text-[10px] uppercase tracking-widest text-brand-accent mb-4 font-bold flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-brand-accent"></span>
            Creation
          </span>
          <h1 className="text-5xl md:text-6xl text-brand-text mb-4 font-serif">Compose a Thought</h1>

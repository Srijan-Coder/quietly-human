...
export default async function GuidePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article className="min-h-screen pt-32 px-6 md:px-12 max-w-4xl mx-auto w-full pb-32">
      ...
      <div className="prose prose-xl prose-stone max-w-none font-sans text-brand-soft leading-loose prose-headings:font-serif prose-headings:text-brand-text prose-headings:font-normal prose-a:text-brand-accent mx-auto">
